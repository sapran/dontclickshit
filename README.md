...
Дякую, що приділяєте увагу власній кібербезпеці. Поділіться цими правилами з близькими, друзями та колегами, щоб зробити світ трохи безпечнішим. Якщо у вас є що додати або ви знайшли в тексті помилку, напишіть на ✉️ vlad@styran.com або [створіть issue](https://github.com/sapran/dontclickshit/issues/new).
