...
1. [Використовуйте пасфрази замість паролів](#Використовуйте-пасфрази-замість-паролів)
...
1. [Використовуйте криптографію](#Використовуйте-криптографію)
...
:bulb: Для додаткового захисту використовуйте *ручну парольну сіль*: вигадайте секретну рядок, зберігайте його в пам'яті, та додавайте його вручну до кожного пароля, який зберігається в менеджері, кожного разу, коли ви вставляєте його в форму аутентифікації.
