...
1. [Загрози на основі штучного інтелекту та діпфейки](#загрози-на-основі-штучного-інтелекту-та-діпфейки)
1. [Використовуйте парольні менеджери](#використовуйте-парольні-менеджери)
1. [Використовуйте двофакторну автентифікацію](#використовуйте-двофакторну-автентифікацію)
1. [Безпека криптовалют та цифрових активів](#безпека-криптовалют-та-цифрових-активів)
1. [Використовуйте безпечні месенджери](#використовуйте-безпечні-месенджери)
1. [Використовуйте віртуальні приватні мережі (VPN)](#використовуйте-віртуальні-приватні-мережі-vpn)
1. [Шифруйте дані](#шифруйте-дані)
1. [Операційна система та програми](#операційна-система-та-програми)
1. [Антивірус](#антивірус)
1. [Фаєрвол](#фаєрвол)
1. [Робіть резервні копії](#робіть-резервні-копії)
1. [Захист від програм-вимагачів та відновлення](#захист-від-програм-вимагачів-та-відновлення)
1. [Мобільна безпека](#мобільна-безпека)
1. [Безпека IoT та розумного дому](#безпека-iot-та-розумного-дому)
1. [Фізична безпека](#фізична-безпека)
1. [Реагування на інциденти: Що робити при компрометації](#реагування-на-інциденти-що-робити-при-компрометації)
1. [Подяка](#подяка)
...
**Що таке підміна SIM-карти (SIM swapping)?**
Зловмисник переконує вашого мобільного оператора перенести ваш номер телефону на SIM-карту, яку він контролює, обходячи двофакторну автентифікацію на базі SMS.
...
- Див. спеціальний розділ [Захист від програм-вимагачів та відновлення](#захист-від-програм-вимагачів-та-відновлення) вище
