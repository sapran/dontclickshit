...
Update third party software regularly or automatically. Modern Windows includes Windows Package Manager (`winget`) which can update installed software. Alternatively, use tools like Chocolatey or Patch My PC.

:wrench: Windows Package Manager: `winget upgrade --all` (built-in to Windows 10/11)
:wrench: Chocolatey: https://chocolatey.org/
...
:wrench: [LuLu](https://objective-see.org/products/lulu.html) (free & open source).
...
:wrench: VeraCrypt: https://veracrypt.fr/en/Home.html
